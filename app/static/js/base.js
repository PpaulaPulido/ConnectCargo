// Base functionality for carrier dashboard
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', (e) => {
        if (e.target.matches('button[type="submit"], .btn-loading')) {
            ...
            if (button && !button.disabled) {
                ...
                // Auto remove loading after form submission
                setTimeout(() => {
    ...
    document.addEventListener('mouseover', (e) => {
        if (e.target.matches('.nav-link, .stat-card, .trip-item, .load-card, .action-btn')) {
